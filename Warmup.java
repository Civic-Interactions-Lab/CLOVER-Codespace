...
// If the word "quit" appears in the array, do not count any subsequent entries.
//
// Example:
...
//
// Example:
// Input: ["hello", "quit", "world"]
// Output: 5 (only "hello" is counted, "world" is after "quit")
//
// Example:
// Input: []
// Output: -1
...
public class Warmup {
     ...
     * If "quit" appears in the array, stops counting at that point.
     * 
